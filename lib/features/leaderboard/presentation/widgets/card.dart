...
/// A single leaderboard row. Automatically renders as a medal-topped
/// highlighted row for ranks 1-3, or a standard row otherwise.
...
class GroupLeaderboardCard extends StatelessWidget {
  const GroupLeaderboardCard({super.key, required this.entry});
